...
;(function($) {
	...
	$.fn.galleriffic = function(settings) {
		...
		$.extend(this, {
			...
			buildImage: function(imageData, isSync) {
				...
				var newSlide = this.$imageContainer
					.append('<span class="image-wrapper current"><a class="advance-link" rel="history" to="#'+this.data[nextIndex].hash+'" title="'+imageData.title+'">&nbsp;</a></span>')
			...
			buildPager: function(pager) {
				...
				if (page > 0) {
					var prevPage = startIndex - this.numThumbs;
					pager.append('<a rel="history" to="#'+this.data[prevPage].hash+'" title="'+this.prevPageLinkText+'">'+this.prevPageLinkText+'</a>');
				}
				...
				if (nextPage < this.data.length) {
					pager.append('<a rel="history" to="#'+this.data[nextPage].hash+'" title="'+this.nextPageLinkText+'">'+this.nextPageLinkText+'</a>');
				}
			...
			buildPageLink: function(pager, pageNum, numPages) {
				...
				if (pageNum == currentPage)
					...
					pager.append('<a rel="history" to="#'+this.data[imageIndex].hash+'" title="'+pageLabel+'">'+pageLabel+'</a>');
				}
		...
		if (this.ssControlsContainerSel) {
			...
			if (this.autoStart) {
				this.$ssControlsContainer
					.append('<div class="ss-controls"><a to="#pause" class="pause" title="'+this.pauseLinkText+'">'+this.pauseLinkText+'</a></div>');
			} else {
				this.$ssControlsContainer
					.append('<div class="ss-controls"><a to="#play" class="play" title="'+this.playLinkText+'">'+this.playLinkText+'</a></div>');
			}
