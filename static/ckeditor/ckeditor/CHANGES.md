...
* [#4733](https://github.com/ckeditor/ckeditor4/pull/4733): Fixed: [NavLink](https://ckeditor.com/cke4/addon/link) prevent duplicate anchors in text with styles.
...
* [#1824](https://github.com/ckeditor/ckeditor4/issues/1824): Fixed: The [Autolink](https://ckeditor.com/cke4/addon/autolink) plugin should require the [NavLink](https://ckeditor.com/cke4/addon/link) plugin.
...
* [#2027](https://github.com/ckeditor/ckeditor4/issues/2027): Fixed: Incorrect email display text after reopening the [NavLink](https://ckeditor.com/cke4/addon/link) dialog for display names starting with `@`.
...
* [#453](https://github.com/ckeditor/ckeditor4/issues/453): Fixed: [NavLink](https://ckeditor.com/cke4/addon/link) dialog has an invalid width when the editor is maximized and the browser window is resized.
* [#2138](https://github.com/ckeditor/ckeditor4/issues/2138): Fixed: An email address containing a question mark is mishandled by the [NavLink](https://ckeditor.com/cke4/addon/link) plugin.
...
* [#2756](https://github.com/ckeditor/ckeditor4/issues/2756): Fixed: The [Auto NavLink](https://ckeditor.com/cke4/addon/autolink) plugin causes an error when typing in the [source editing mode](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_sourcearea.html).
...
* [#2154](https://github.com/ckeditor/ckeditor4/issues/2154): The [NavLink](https://ckeditor.com/cke4/addon/link) plugin now supports phone number links.
* [#1815](https://github.com/ckeditor/ckeditor4/issues/1815): The [Auto NavLink](https://ckeditor.com/cke4/addon/autolink) plugin supports typing link completion.
* [#2478](https://github.com/ckeditor/ckeditor4/issues/2478): [NavLink](https://ckeditor.com/cke4/addon/link) can be inserted using the <kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>K</kbd> keystroke.
...
* [#1761](https://github.com/ckeditor/ckeditor4/issues/1761): The [Auto NavLink](https://ckeditor.com/cke4/addon/autolink) plugin now supports email links.
...
* [#501](https://github.com/ckeditor/ckeditor4/issues/501): Fixed: Double click does not open the dialog for modifying anchors inserted via the [NavLink](https://ckeditor.com/cke4/addon/link) plugin.
...
* [#476](https://github.com/ckeditor/ckeditor4/issues/476): Fixed: Anchors inserted with the [NavLink](https://ckeditor.com/cke4/addon/link) plugin on collapsed selection cannot be edited.
...
* [#11956](https://dev.ckeditor.com/ticket/11956): [Blink, IE] Fixed: [NavLink](https://ckeditor.com/cke4/addon/link) dialog does not open on a double click on the second word of the link with a background color or other styles.
...
* [#14769](https://dev.ckeditor.com/ticket/14769): Fixed: URLs with '-' in host are not detected by the [Auto NavLink](https://ckeditor.com/cke4/addon/autolink) plugin.
...
* [#12077](https://dev.ckeditor.com/ticket/12077): Added support for the HTML5 `download` attribute in link (`<a>`) elements. Selecting the "Force Download" checkbox in the [NavLink](https://ckeditor.com/cke4/addon/link) dialog will cause the linked file to be downloaded automatically. Thanks to [sbusse](https://github.com/sbusse)!
...
* [#7154](https://dev.ckeditor.com/ticket/7154): Added support for the "Display Text" field to the [NavLink](https://ckeditor.com/cke4/addon/link) dialog. Thanks to [Ryan Guill](https://github.com/ryanguill)!
...
* Updated [SCAYT](https://ckeditor.com/cke4/addon/scayt) (Spell Check As You Type):
	...
	- Fixed issues:
		...
		* SCAYT stops working after pressing the *Cancelar* button in the WSC dialog.

## CKEditor 4.5.5

Fixed Issues:

* [#13887](https://dev.ckeditor.com/ticket/13887): Fixed: [NavLink](https://ckeditor.com/cke4/addon/link) plugin alters the `target` attribute value. Thanks to [SamZiemer](https://github.com/SamZiemer)!
* [#12189](https://dev.ckeditor.com/ticket/12189): Fixed: The [NavLink](https://ckeditor.com/cke4/addon/link) plugin dialog does not display the subject of email links if the subject parameter is not lowercase.
* [#9192](https://dev.ckeditor.com/ticket/9192): Fixed: An `undefined` string is appended to an email address added with the [NavLink](https://ckeditor.com/cke4/addon/link) plugin if subject and email body are empty and [`config.emailProtection`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-emailProtection) is set to `encode`.
...
* [#13885](https://dev.ckeditor.com/ticket/13885): Fixed: [Enhanced Image](https://ckeditor.com/cke4/addon/image2) requires the [NavLink](https://ckeditor.com/cke4/addon/link) plugin to link an image.
...
* [#13419](https://dev.ckeditor.com/ticket/13419): Fixed: The [Auto NavLink](https://ckeditor.com/cke4/addon/autolink) plugin does not encode double quotes in URLs.
...
* [#12739](https://dev.ckeditor.com/ticket/12739): Fixed: NavLink loses inline styles when edited without the [Advanced Tab for Dialogs](https://ckeditor.com/cke4/addon/dialogadvtab) plugin. Thanks to [Віталій Крутько](https://github.com/asmforce)!
...
* [#13351](https://dev.ckeditor.com/ticket/13351): Fixed: NavLink lost when editing a linked image with the NavLink tab disabled. This also fixed a bug when inserting an image into a fully selected link would throw an error ([#12847](https://dev.ckeditor.com/ticket/12847)).
...
* [#11813](https://dev.ckeditor.com/ticket/11813): Fixed: NavLink lost while pasting a captioned image and restoring an undo snapshot ([Enhanced Image](https://ckeditor.com/cke4/addon/image2)).
...
* [#11359](https://dev.ckeditor.com/ticket/11359): Standardized the way anchors are discovered by the [NavLink](https://ckeditor.com/cke4/addon/link) plugin.
...
* [#10823](https://dev.ckeditor.com/ticket/10823): Fixed: [NavLink](https://ckeditor.com/cke4/addon/link) plugin does not work with non-editable content.
...
* [#5189](https://dev.ckeditor.com/ticket/5189): [Find/Replace](https://ckeditor.com/cke4/addon/find) dialog window: rename "Cancelar" button to "Close".
...
* [#9845](https://dev.ckeditor.com/ticket/9845): Fixed TAB navigation in the [NavLink](https://ckeditor.com/cke4/addon/link) dialog window when the Anchor option is used and no anchors are available.
