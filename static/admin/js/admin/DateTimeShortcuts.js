...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        addClock: function(inp) {
            ...
            //     <ul class="timelist">
            //         <li><a to="#">Now</a></li>
            //         <li><a to="#">Midnight</a></li>
            //         <li><a to="#">6 a.m.</a></li>
            //         <li><a to="#">Noon</a></li>
            //         <li><a to="#">6 p.m.</a></li>
            //     </ul>
            //     <p class="calendar-cancel"><a to="#">Cancelar</a></p>
            // </div>
            ...
            const cancel_link = quickElement('a', cancel_p, gettext('Cancelar'), 'href', '#');
        ...
        addCalendar: function(inp) {
            ...
            //     <h2>
            //           <a to="#" class="link-previous">&lsaquo;</a>
            //           <a to="#" class="link-next">&rsaquo;</a> February 2003
            //     </h2>
            //     <div class="calendar" id="calendarin3">
            //         <!-- (cal) -->
            //     </div>
            //     <div class="calendar-shortcuts">
            //          <a to="#">Yesterday</a> | <a to="#">Today</a> | <a to="#">Tomorrow</a>
            //     </div>
            //     <p class="calendar-cancel"><a to="#">Cancelar</a></p>
            // </div>
